import{S as u,i as y,s as m,e as f,c as g,b,d as l,h as _,l as h,p as i,t as d,g as c,m as o,o as p}from"./index.3d718cdb.js";/* empty css                                              */function x(r){let e;return{c(){e=f("div"),this.h()},l(n){e=g(n,"DIV",{id:!0,class:!0}),b(e).forEach(l),this.h()},h(){_(e,"id","loading"),_(e,"class","svelte-1e2b3ig")},m(n,t){h(n,e,t)},p:i,i,o:i,d(n){n&&l(e)}}}class $ extends u{constructor(e){super(),y(this,e,null,x,m,{})}}function v(r){let e,n,t;return{c(){e=f("div"),n=d("DESDR: "),t=d(r[0]),this.h()},l(a){e=g(a,"DIV",{class:!0});var s=b(e);n=c(s,"DESDR: "),t=c(s,r[0]),s.forEach(l),this.h()},h(){_(e,"class","text-center py-5 px-2 text-4xl font-bold")},m(a,s){h(a,e,s),o(e,n),o(e,t)},p(a,[s]){s&1&&p(t,a[0])},i,o:i,d(a){a&&l(e)}}}function k(r,e,n){let{country:t}=e;return r.$$set=a=>{"country"in a&&n(0,t=a.country)},[t]}class D extends u{constructor(e){super(),y(this,e,k,v,m,{country:0})}}const E=`backends:
- type: duckdb
  name: duckdb
  sources:
...
- type: BarGrouped   
  ...
  overlays:
    ...
    madagascar_forecasts:
      ...
      default: false
    excess_rain:
      label: "Community Reported Excess Rain Years"
      stroke: "#1e90ff"
      fill: "#87cefa"
      default: false
    drought_badyears:
      label: "Community Reported Drought Years"
      stroke: "#b8860b"
      fill: "#f4d06f"
      default: false
    ipc:
      label: "National Food Insecurity Ranking"
      stroke: "#004204"
      fill: "#009907"
      default: false
  data:
...
- type: Slider
  ...
  min: 19
  max: 55
  description: "Drought (Window 1)"
  tooltip: "This sets the time period for measuring drought during the early season."
  interactions:
  - type: change
    to: 
    - backend: severity_combined 
...
- type: Slider
  ...
  min: 19
  max: 55
  description: "Drought (Window 2)"
  tooltip: "This sets the time period for measuring drought during the late season."
  interactions:
  - type: change
    to: 
    - backend: severity_combined
...
- type: Slider
  ...
  min: 19
  max: 55
  description: "Excess Rainfall (Window 1)"
  tooltip: "This sets the time period for measuring excess rainfall during the early season."
  interactions:
  - type: change
    to: 
    - backend: severity_combined
...
- type: Slider
  ...
  min: 19
  max: 55
  description: "Excess Rainfall (Window 2)"
  tooltip: "This sets the time period for measuring excess rainfall during the late season."
  interactions:
  - type: change
    to: 
    - backend: severity_combined
...
- type: SliderFreq
  ...
  tooltip: "This slider sets the percentage of years in which AA would have triggered."
  interactions:
  - type: change
    to:
    - backend: severity_combined 
...
- type: Slider
  ...
  tooltip: "This slider sets the start and end year of the analysis period."
  interactions:
  - type: change
    to:
    - backend: severity_combined 

import{S as u,i as m,s as y,e as f,c as g,b,d as _,h as l,l as h,o as i,t as d,g as c,m as o,w as p}from"./index.2a3ac341.js";/* empty css                                              */function x(r){let e;return{c(){e=f("div"),this.h()},l(n){e=g(n,"DIV",{id:!0,class:!0}),b(e).forEach(_),this.h()},h(){l(e,"id","loading"),l(e,"class","svelte-1e2b3ig")},m(n,t){h(n,e,t)},p:i,i,o:i,d(n){n&&_(e)}}}class $ extends u{constructor(e){super(),m(this,e,null,x,y,{})}}function v(r){let e,n,t;return{c(){e=f("div"),n=d("DESDR: "),t=d(r[0]),this.h()},l(a){e=g(a,"DIV",{class:!0});var s=b(e);n=c(s,"DESDR: "),t=c(s,r[0]),s.forEach(_),this.h()},h(){l(e,"class","text-center py-5 px-2 text-4xl font-bold")},m(a,s){h(a,e,s),o(e,n),o(e,t)},p(a,[s]){s&1&&p(t,a[0])},i,o:i,d(a){a&&_(e)}}}function k(r,e,n){let{country:t}=e;return r.$$set=a=>{"country"in a&&n(0,t=a.country)},[t]}class D extends u{constructor(e){super(),m(this,e,k,v,y,{country:0})}}const E=`backends:
- type: duckdb
  name: duckdb
  sources:
